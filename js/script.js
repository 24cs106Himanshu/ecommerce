...
window.PRODUCTS = [
  ...
  { id:3,  brand:'8BitDo',      name:'Ultimate 2.4G Wireless Controller',     price:5490,  was:7490,  rating:4.7, reviews:2198, cat:'controllers', tag:'sale',img:'https://images.unsplash.com/photo-1593508512255-86ab42a8e620?w=600&q=85', disc:27 },
  { id:4,  brand:'Razer',       name:'Wolverine V3 Pro Gaming Controller',    price:22990, was:27990, rating:4.6, reviews:1432, cat:'controllers', tag:'',    img:'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=600&q=85', disc:18 },
  ...
  { id:7,  brand:'Corsair',     name:'HS80 RGB Wireless Gaming Headset',      price:8990,  was:12990, rating:4.6, reviews:3411, cat:'headsets',    tag:'sale',img:'https://images.unsplash.com/photo-1484704849700-f032a568e944?w=600&q=85', disc:31 },
  { id:8,  brand:'Logitech',    name:'G Pro X 2 Lightspeed Headset',         price:18990, was:23990, rating:4.7, reviews:1876, cat:'headsets',    tag:'',    img:'https://images.unsplash.com/photo-1524678606370-a47ad25cb82a?w=600&q=85', disc:21 },
  ...
  { id:11, brand:'NVIDIA',      name:'GeForce RTX 4070 Super 12GB',          price:54990, was:64990, rating:4.8, reviews:4312, cat:'gpu',         tag:'sale',img:'https://images.unsplash.com/photo-1560472355-536de3962603?w=600&q=85', disc:15 },
  { id:12, brand:'AMD',         name:'Radeon RX 7800 XT 16GB',               price:39990, was:49990, rating:4.6, reviews:2134, cat:'gpu',         tag:'',    img:'https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&q=85', disc:20 },
  { id:13, brand:'LG',          name:'UltraGear 27" 4K 144Hz OLED Monitor',  price:74990, was:89990, rating:4.9, reviews:2876, cat:'monitors',    tag:'new',  img:'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=600&q=85', disc:17 },
  { id:14, brand:'Samsung',     name:'Odyssey G9 49" Ultra-Wide 240Hz',      price:99990, was:129990,rating:4.8, reviews:1654, cat:'monitors',    tag:'',    img:'https://images.unsplash.com/photo-1547119957-637f8679db1e?w=600&q=85', disc:23 },
  { id:15, brand:'ASUS',        name:'ROG Swift 360Hz FHD 1ms Monitor',      price:42990, was:54990, rating:4.7, reviews:3298, cat:'monitors',    tag:'sale',img:'https://images.unsplash.com/photo-1585792180666-f7347c490ee2?w=600&q=85', disc:22 },
  { id:16, brand:'BenQ',        name:'MOBIUZ EX2780Q 27" QHD 165Hz IPS',    price:34990, was:42990, rating:4.6, reviews:1876, cat:'monitors',    tag:'',    img:'https://images.unsplash.com/photo-1498049794561-7780e7231661?w=600&q=85', disc:19 },
  { id:17, brand:'Razer',       name:'BlackWidow V4 Pro Mechanical Keyboard',price:18990, was:22990, rating:4.8, reviews:5432, cat:'peripherals', tag:'new',  img:'https://images.unsplash.com/photo-1615663245857-ac93bb7c39e7?w=600&q=85', disc:17 },
  { id:18, brand:'Logitech',    name:'G Pro X Superlight 2 Mouse',           price:11990, was:14990, rating:4.9, reviews:7891, cat:'peripherals', tag:'',    img:'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=600&q=85', disc:20 },
  { id:19, brand:'SteelSeries', name:'QcK Prism XL RGB Mousepad',            price:5990,  was:8990,  rating:4.7, reviews:2341, cat:'peripherals', tag:'sale',img:'https://images.unsplash.com/photo-1547658719-da2b51169166?w=600&q=85', disc:33 },
  { id:20, brand:'Corsair',     name:'K100 Air Wireless Keyboard',           price:24990, was:29990, rating:4.6, reviews:1654, cat:'peripherals', tag:'',    img:'https://images.unsplash.com/photo-1541140532154-b024d705b90a?w=600&q=85', disc:17 },
  { id:21, brand:'Secretlab',   name:'TITAN Evo 2022 L Gaming Chair',        price:39990, was:49990, rating:4.9, reviews:3421, cat:'chairs',      tag:'new',  img:'https://images.unsplash.com/photo-1598550874175-4d0ef436c909?w=600&q=85', disc:20 },
  { id:22, brand:'DXRacer',     name:'Formula Series Racing Chair',          price:19990, was:27990, rating:4.6, reviews:2134, cat:'chairs',      tag:'',    img:'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=600&q=85', disc:29 },
  { id:23, brand:'Herman Miller',name:'Embody Gaming Chair x Logitech G',    price:149990,was:169990,rating:4.8, reviews:876,  cat:'chairs',      tag:'',    img:'https://images.unsplash.com/photo-1598550874175-4d0ef436c909?w=600&q=85', disc:12 },
  { id:24, brand:'AndaSeat',    name:'Kaiser 4 XL Premium Gaming Chair',     price:24990, was:32990, rating:4.7, reviews:1987, cat:'chairs',      tag:'sale',img:'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=600&q=85', disc:24 },
];
